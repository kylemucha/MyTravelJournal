...
A simple static web application built to practice the use of props in React. Using props, I was able to display a basic travel journal using dynamic components that are imported from a database.
